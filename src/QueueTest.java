...
// Will enqueue a word which will test if it will go back to position 0 to put it in as capacity is 4
        JOptionPane.showMessageDialog(null, "About to enqueue words onto queue: \nDoes it loop back\nObject 5");
        ...
        while(! q.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Word dequeued: " + word1);
        }
        System.exit(0);
    }
}